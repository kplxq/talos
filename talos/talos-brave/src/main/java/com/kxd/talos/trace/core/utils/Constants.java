...
public final class Constants {
 ...
 public static final String TRACE_SPAN_ID_START_INDEX = "1";
	
	
 public static final String TRACE_SPAN_ID_SPLIT = ".";
 
 public static final String TRACE_FIRST_CHILD_ID = "0.1";
 
 public static final String TRACE_ROOT_SPAN_ID = "0";
  ...
  public static final String SPAN_NAME_LOCAL = "sp.local";
  
  public static final String SPAN_NAME_RPC_DUBBO_CLIENT = "sp.rpc.dubbo.client";
  
  public static final String SPAN_NAME_RPC_DUBBO_SERVER = "sp.rpc.dubbo.server";
  
  public static final String SERVICE_TYPE_LOCAL = "local";
  
  public static final String SERVICE_TYPE_DUBBO_CLIENT = "dubbo-client";
  
  public static final String SERVICE_TYPE_DUBBO_SERVER = "dubbo-server";
