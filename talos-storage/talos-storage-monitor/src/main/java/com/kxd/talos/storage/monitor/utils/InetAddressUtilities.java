...
public class InetAddressUtilities {
	...
	/**
	 * <p>
	 * This code is copied from <a href=
	 * "http://stackoverflow.com/questions/9481865/getting-the-ip-address-of-the-current-machine-using-java"
	 * >a Stackoverflow post</a>. and was originally copied from <a
	 * href="https://issues.apache.org/jira/browse/JCS-40">here</a>.
	 * </p>
			...
			for (Enumeration<NetworkInterface> ifaces = NetworkInterface
				...
				for (Enumeration<InetAddress> inetAddrs = iface
					...
					InetAddress inetAddr = (InetAddress) inetAddrs
							.nextElement();
					System.out.println("address is " + inetAddr);
	...
	public static int toInt(String ipAddress) throws UnknownHostException {
	...
	public static void main(String[] args) throws UnknownHostException {
		...
		System.out.println(" address is " + address + " and to int is "
				+ toInt(address));
